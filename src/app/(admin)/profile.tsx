  ...
  const handleSelectPreset = async (presetUrl: string) => {
    ...
    try {
      ...
      if (res.success) {
        ...
        showZeeAlert("Success", "Avatar updated!", [{ text: "OK" }], "success");
      }
    } catch (err) {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.scrollContent}>
      <View style={styles.profileHeader}>
        ...
        <Text style={styles.userName}>{user?.name || "School Administrator"}</Text>
        <Text style={styles.userEmail}>{user?.email}</Text>

        <View style={styles.roleChip}>
          <ShieldCheck size={14} color={ZEEPREP_THEME.colors.primary} />
          <Text style={styles.roleChipText}>ADMINISTRATOR PORTAL</Text>
        </View>
        ...
        >
          ...
          <Text style={styles.changePhotoBtnText}>
            {hasCustomPhoto ? "Change Profile Photo" : "Upload Profile Photo"}
          </Text>
        </TouchableOpacity>
      </View>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalCard}>
            <View style={styles.modalHeader}>
              <Text style={styles.modalTitle}>Admin Profile Photo</Text>
            ...
            <Text style={styles.presetSectionTitle}>Or select an administrator avatar:</Text>
            <View style={styles.presetsGrid}>
              {ADMIN_AVATAR_PRESETS.map((preset, idx) => (
                <TouchableOpacity
                  key={idx}
